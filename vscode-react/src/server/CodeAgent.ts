...
export class CodeAgent {
  ...
  */
  ...
  private postMessage: any; // TODO: types
...
//                     reason: {
//                         type: "string",
//                         description: "The reason for the status. If complete, provide a brief summary of how the acceptance criteria were met. If incomplete, provide a precise and concise analysis of the missing criteria and what needs to be done to complete the code.",
//                     },
//                 },
...
//                     question: {
//                         type: "string",
//                         description: "The question to ask the user. Be as precise, specific, clear, detailed as possible while remaining concise.",
//                     },
//                 },
// 			},
// 		},
...
//     }
//     const isDone = JSON.parse(taskStatusToolCall?.function?.arguments || "{}")?.status === "complete";
